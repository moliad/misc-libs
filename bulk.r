REBOL [
	...
	documentation: {
		...
		where:
			...
			always PROBE it.  In R3,  the header will be explicitely unbound.
		...
		-Generic tools for convertion, disk & networking can safely convert any bulk with minimal fuss,
